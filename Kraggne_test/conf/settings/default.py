...
# Django settings for Kraggne_test project.
...
SECRET_KEY = '9)^j#r6!1v%&$q4&fs@#g37qm^6wvrw7vywar%rkx$gqs#%$()'
...
ROOT_URLCONF = 'Kraggne_test.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Kraggne_test.wsgi.application'
